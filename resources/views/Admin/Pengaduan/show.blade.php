                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @elseif($pengaduan->status == 'selesai')
                                        <a href="" class="badge badge-succes text-white">selesai</a>
                                    @else
                ...
                <div class="card-body">
                    <form action="{{ route('tanggapan.createOrUpdate') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea required name="tanggapan" id="tanggapan" rows="4" class="form-control" placeholder="Belum ada tanggapan">{{ $tanggapan->tanggapan ?? '' }}</textarea>
                        </div>

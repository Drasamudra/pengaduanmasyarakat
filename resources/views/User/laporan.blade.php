...
@section('title', 'Pengaduan Desa Kalibaru')
        ...
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('pekat.index') }}">
                    <h4 class="semi-bold mb-0 text-white">PDK</h4>
                    <p class="italic mt-0 text-white">Pengaduan Desa Kalibaru</p>
                </a>
            ...
            <div class="content content-bottom shadow">
                <div>
                    ...
                    <div class="self-align">
                        <h5><a style="color: #fff" href="#">{{ Auth::guard('masyarakat')->user()->nama }}</a></h5>
                        <p style="color: #fff">{{ Auth::guard('masyarakat')->user()->username }}</p>
                    </div>
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">• All rights reserved •</p>
    </div>
</div>
@endsection
